            ...
            <div className="col-12 col-md-10">
                ...
                <div className="row pr-4">
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white o-hidden h-100 bg-success">
                            <div className="card-body">
                    ...
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white o-hidden h-100" style={{backgroundColor:'#fd1d1d'}}>
                            <div className="card-body">
                    ...
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white  o-hidden h-100" style={{backgroundColor:'#060553'}}>
                            <div className="card-body">
