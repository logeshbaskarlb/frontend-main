...
export const getProducts = (keyword, price, category, rating, currentPage) => async (dispatch) => {
    ...
    try {  
        ...
        let link = `https://backend-h5vo.onrender.com/api/v1/products?page=${currentPage}`;
...
export const getProduct = id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`https://backend-h5vo.onrender.com/api/v1/product/${id}`,
        {
            headers:{
...
export const getAdminProducts  =  async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`https://backend-h5vo.onrender.com/api/v1/admin/products`,
        {
            headers:{
                authorization:localStorage.getItem('token')
            }
...
export const createNewProduct  =  productData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.post(`https://backend-h5vo.onrender.com/api/v1/admin/product/new`, productData,
