...
export const register = (userData) => async (dispatch) => {
    ...
    try {
        ...
        const { data }  = await axios.post(`https://backend-h5vo.onrender.com/api/v1/register`,userData, config);
...
export const updateProfile = (userData) => async (dispatch) => {
    ...
    try {
        ...
        const { data }  = await axios.put(`https://backend-h5vo.onrender.com/api/v1/update`,userData, config);
